  ...
  <span class="shadowConf shadeau"></span>
   <div class="wrapper confUneBackground">
    <div id="confUneText">
    		...
    		<h1><a href="<?php echo get_permalink(178); ?>">Les méthodes d'influence dans le web</a><span>15 minutes</span></h1>
      ...
      <span id="confUneHover"><a href="<?php echo get_permalink(178); ?>"></a></span> 
      <span class="shadowConf shadeau"></span>
   </div><!-- *** END WRAPPER *** -->	   
  </div><!-- *** END ConfUne *** -->	
  ...
  <?php while ( have_posts() ) : the_post(); ?>
        ...
        if ( $query->have_posts() ) {
        	while ( $query->have_posts() ) {
        		$query->the_post();
            get_template_part( 'content-conferencetest' );
        	}
        } else {
        	// no posts found
        }
